function latents = kalman_filter(data)
    ...
    for n = 1:N
        ...
        % store tau latents for irreducible uncertainty (cond: 1 = RS, 2 = SR, 3 = RR, 4 = SS):
        switch data.cond(n)
            
            case 1
                latents.tau(n,:) = [V(2) V(1)];
        
            case 2
                latents.tau(n,:) = [V(1) V(2)];
            
            case 3         
                latents.tau(n,:) = [V(2) V(2)];
            
            case 4
                latents.tau(n,:) = [V(1) V(1)];
        end
